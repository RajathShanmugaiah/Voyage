									...
									&nbsp; &nbsp; 
											...
											<div className="quill-inputBox">
												...
												<form>
													...
													<br/>
													<div class="row">
														<a class="btn btn-lg  btn-success" style={{fontSize:"20px", alignItems:"center", color:"white",marginLeft:"2%"}} onClick={this.onClick}> <i class="fa fa-check" aria-hidden="true"></i> &nbsp;Submit </a>
													</div>
												</form>
